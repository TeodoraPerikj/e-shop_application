...
import mk.ukim.finki.servlet_thymeleaf.model.exceptions.ProductAlreadyInShoppingCartException;
import mk.ukim.finki.servlet_thymeleaf.model.exceptions.ProductNotFoundException;
import mk.ukim.finki.servlet_thymeleaf.model.exceptions.ShoppingCartNotFoundException;
import mk.ukim.finki.servlet_thymeleaf.model.exceptions.UserNotFoundException;
import mk.ukim.finki.servlet_thymeleaf.repository.impl.InMemoryShoppingCartRepository;
import mk.ukim.finki.servlet_thymeleaf.repository.impl.InMemoryUserRepository;
import mk.ukim.finki.servlet_thymeleaf.repository.jpa.ShoppingCartRepository;
...
public class ShoppingCartServiceImpl implements ShoppingCartService {
    ...
    @Override
    public List<Product> findAllProductsInShoppingCart(Long cartId) {
    ...
    public ShoppingCart addProductToShoppingCart(String username, Long productId) {
        ...
        if(cart.getProducts().stream().filter(pr -> pr.getId().equals(productId))
